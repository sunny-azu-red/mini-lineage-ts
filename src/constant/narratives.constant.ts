export const RACE_TRAITS_TEMPLATES: Record<number, string> = {
    ...
    1: `They embark with a fortified <span class="hp">{hp} HP</span> and a starting tribute of <span class="gold">🪙 {adena} Adena</span>, though their raw, unweighted strikes offer a <span class="crit">{crit}% Critical Chance</span>. Their iron-like biology allows for <span class="heal">+{regen} Regeneration</span> during moments of rest, while their massive, unmistakable presence results in a dangerous <span class="muted">{ambush}% Ambush Risk</span>.`,
